...
public class ChangeStatus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String course_id = request.getParameter("slct");
        String student_id = request.getParameter("studentslct");
        String status = request.getParameter("status");
        LocalDate date = LocalDate.parse(request.getParameter("date"));
        Database database = (Database) request.getSession().getAttribute("database");
        database.updateAttendance(date, student_id, course_id, status);
        response.sendRedirect("Modify");
//      RequestDispatcher ds = request.getRequestDispatcher("Modify");
